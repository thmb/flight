...
import pytest
from source_sap_odata.source import SapOdataStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SapOdataStream, "path", "v0/example_endpoint")
    mocker.patch.object(SapOdataStream, "primary_key", "test_primary_key")
    mocker.patch.object(SapOdataStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SapOdataStream()
